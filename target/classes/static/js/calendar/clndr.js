...
;(function ( $, window, document, undefined ) {
  ...
  function Clndr( element, options ) {
    ...
    // merge the default options with userController-provided options
  ...
  Clndr.prototype.render = function() {
    ...
    if(this.options.constraints) {
      ...
      // today? we could put this in init(), but we want to support the userController changing the constraints on a living instance.
  ...
  // If the userController provided a click callback we'd like to give them something nice to work with.
