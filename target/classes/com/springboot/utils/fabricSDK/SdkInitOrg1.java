...
public class SdkInitOrg1 {
    ...
    public static Object install(String chaincodeVersion, String chaincodeLocation, String chaincodeName) {
        try {
            ...
            userContext.setMspId("Org1MSP");//设置MSP
            userContext.setAccount("李伟");//账户
            userContext.setName("admin");//设置名称
            Enrollment enrollment = UserUtils.getEnrollment(org1KeyFolderPath, org1KeyFileName, org1CertFoldePath, org1CertFileName);//org1key、证书路径、文件名
            userContext.setEnrollment(enrollment);
            FabricClient fabricClient = new FabricClient(userContext);
            Peer peer0 = fabricClient.getPeer("peer0.org1.example.com", "grpcs://peer0.org1.example.com:7051", org1TlsPeerFilePath);//get节点信息 参数：节点名称、grpcurl、tls文件路径
