...
public class AdminUpdateRecordAuthController {

    @Autowired
    private AdminBrowseRecordAuthService adminBrowseRecordAuthServiceImpl;
    @Autowired
    private AdminUpdateRecordAuthService adminUpdateRecordAuthServiceImpl;
    ...
    public String loginPost(@Param("recordAuthId") String recordAuthId, Model model) {
        ...
        return "admin/recordAuth/updateRecordAuth";
    }
