...
@Service
public class AdminBrowseRecordAuthServiceImpl implements AdminBrowseRecordAuthService {
    ...
    public List<Map<String, Object>> adminBrowseAllRecordAuth() {
        try {
            ...
            for (Map<String, Object> keyValue : recordAuths
                ...
                Map<String, Object> recordAuth = recordAuthDaoImpl.selectRecordAuthByRecordAuthId(keyValue1.getValueA());//查所有变成根据id查
