...
public class RecordAdminUpdateRecordInfoController {

    @Autowired
    private RecordAdminBrowseRecordInfoService adminBrowseRecordInfoServiceImpl;
    @Autowired
    private RecordAdminUpdateRecordInfoService adminUpdateRecordInfoServiceImpl;
    ...
    public String loginPost(@Param("recordId") String recordId, Model model) {
        ...
        return "recordAdmin/recordInfo/updateRecordInfo";
    }
