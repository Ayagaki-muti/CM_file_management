...
import com.springboot.service.user.userInfo.UserBrowseUserInfoService;
 ...
 * */
@RequestMapping("user")
public class UserUpdateUserInfoController {

    @Autowired
    private UserUpdateUserInfoService adminUpdateUsrInfoServiceImpl;
    @Autowired
    private UserBrowseUserInfoService adminBrowseUserInfoServiceImpl;
    ...
    public String loginPost(@Param("userId") String userId, Model model) {
        ...
        return "user/userInfo/updateUserInfo";
    }
