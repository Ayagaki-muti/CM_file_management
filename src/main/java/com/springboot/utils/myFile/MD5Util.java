...
public class MD5Util {
    ...
    /**
     * 寻找文件名为fileName的文件内容hash值
     */
    public static String getFileMD5HashCode32ByFileName(String fileName) {
        try {
            String filePath = recordFilePath + fileName;
    ...
    public static String getFileMD5HashCode32ByInputStream(InputStream inputStream) {
        String md5Hashcode32 = md5HashCode32(inputStream);
        return md5Hashcode32;
    }
